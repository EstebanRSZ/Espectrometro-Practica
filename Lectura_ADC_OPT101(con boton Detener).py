...
# ~300 ms. Por eso no se debe convertir "numero de muestra" como si fuera
# "numero de paso del motor". Se estima la posicion con el tiempo real del
# barrido medido experimentalmente.
WAVELENGTH_START_NM = 425.0
WAVELENGTH_END_NM = 725.0
SCAN_DURATION_S = 12.55
...
class Opt101App(QMainWindow):
    ...
    def _prepare_new_scan(self) -> None:
        self.samples.clear()
        self._latest_sample = None
        self.start_time = time.time()
